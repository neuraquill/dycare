...
class AppColors {
  ...
  // Secondary colors
  static const Color secondary = Color(0xFF88A2D9); // Soft Blue
  static const Color secondaryDark = Color(0xFF7593D3); // Cool Blue
  static const Color secondaryLight = Color(0xFFA8BCE2); // Sky Blue
  ...
  // Accent colors
  static const Color accentPink = Color(0xFFFFC1E3); // Keeping original

  // Custom colors
  static const Color booked = Color(0xFFE1E2E1); // Keeping original
